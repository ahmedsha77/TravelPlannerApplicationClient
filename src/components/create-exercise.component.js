...
export default class CreateExercise extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('https://travel-planner123.herokuapp.com/exercises/add', exercise)
  ...
  render() {
    ...
    <div>
      ...
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group">
          <input type="submit" value="Create Vacation Log" className="btn btn-primary" />
        </div>
      </form>
    </div>
    )
